  ...
  if (!lesson) {
    return (
      <div className="min-h-screen bg-gray-50">
        <PageHeader title="Grammar" onBack={() => navigate('/destination/b1')} />
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader
        ...
        onBack={() => navigate('/destination/b1')}
      />

      <div className="max-w-3xl mx-auto px-4 py-4 pb-10">
        {/* Title card */}
        <div className="bg-blue-700 text-white rounded-xl p-4 mb-4">
          <div className="text-xs text-blue-200 mb-1">Destination B1 · Unit {lesson.unit}</div>
